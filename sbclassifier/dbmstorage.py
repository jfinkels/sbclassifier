...
#: What DBM storage type should we use?  Must be best, db3hash, dbhash or gdbm.
#: Windows folk should steer clear of dbhash.  Default is "best", which will
#: pick the best DBM type available on your platform.
DBM_TYPE = 'best'
